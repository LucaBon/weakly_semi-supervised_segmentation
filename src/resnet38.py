...
class ResBlock(nn.Module):
    def __init__(self,
        ...
        self.conv_branch2a = nn.Conv2d(in_channels,
                                       mid_channels,
                                       3,
                                       stride,
        ...
        self.conv_branch2b1 = nn.Conv2d(mid_channels,
                                        out_channels,
                                        3,
                                        padding=dilation,
                                        dilation=dilation,
        ...
        if not self.same_shape:
            self.conv_branch1 = nn.Conv2d(in_channels,
                                          out_channels,
                                          1,
                                          stride,
                                          bias=False)
...
class ResBlockBot(nn.Module):
    def __init__(self,
        ...
        self.conv_branch2b1 = nn.Conv2d(out_channels//4,
                                        out_channels//2,
                                        3,
                                        padding=dilation,
                                        dilation=dilation,
        ...
        self.conv_branch2b2 = nn.Conv2d(out_channels//2,
                                        out_channels,
                                        1,
                                        bias=False)
...
class ResNet38(BaseNet):
    ...
    def __init__(self):
        ...
        self.b6 = ResBlockBot(1024, 2048, stride=1, dilation=4, dropout=0.3)

        self.b7 = ResBlockBot(2048, 4096, dilation=4, dropout=0.5)
